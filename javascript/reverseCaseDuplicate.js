...
const reverseCaseDuplicate = (string) =>
  string
    .split('')
    .map((letter, index, arr) =>
      (letter === arr[index + 1] || letter === arr[index -1])
...
console.log(
  reverseCaseDuplicate("puzzles"), // Expected Result: "puZZles"
  reverseCaseDuplicate("massive"), // Expected Result: "maSSive"
  reverseCaseDuplicate("LITTLE"), // Expected Result: "LIttLE"
  reverseCaseDuplicate("shhh") // Expected Result: "sHHH"
);
